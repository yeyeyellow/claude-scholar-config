...
- stays lightweight enough to refresh after each major external source ingestion.
...
- new external source-sourced paper notes are added,
...
- a batch external source review or note-ingestion pass finishes,
